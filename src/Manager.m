...
+ (BOOL)DevOptions {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"dev_options"];
}
+ (BOOL)MusicStickers {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"music_stickers"];
}
+ (BOOL)ShareComment {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"share_comment"];
}
+ (BOOL)ShareLoc {
    return [[NSUserDefaults standardUserDefaults] boolForKey:@"share_loc"];
}
+ (BOOL)FLEX {
