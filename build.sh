...
then
    ...
    rm -f packages/RaulGram.ipa
    pyzule -i "packages/${ipaFile}" -o packages/RaulGram.ipa -f .theos/obj/debug/SCInsta.dylib .theos/obj/debug/sideloadfix.dylib $FLEXPATH -c 0 -m 15.0 -du
